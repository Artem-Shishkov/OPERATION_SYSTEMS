...
## Выполнили: студенты группы 2272, Шишков Артём Евгеньевич, Шкаленов Сергей Алексеевич
...
Параллельный процесс + синхронизация + общий ресурс. Делаем через потоки (threads) с мьютексом и записью в общий файл. 
| Требование | Реализация |
| :--- | :--- |
| Параллельный процесс | Два потока std::thread (t1 и t2) |
| Общий ресурс | Файл fib_result.txt |
| Синхронизация	| std::mutex + std::lock_guard — потоки пишут в файл по очереди |

# Лабораторная работа №2 (Установка Linux) - в Releases
